      ...
      <MaxWContainer className="z-[6] relative flex flex-col items-start justify-center space-y-3">
        ...
        >
          <motion.div
            ...
            className="pt-3.5"
          >
            <h1 className="bg-gradient-to-r from-primary/90 via-primary to-primary/90 bg-clip-text text-transparent leading-[50px] md:leading-[95px] md:text-[100px] text-[46px] font-bold tracking-tight">
