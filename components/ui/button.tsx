...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap app-radius-lg text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 outline-none ring-0 select-none",
  {
    variants: {
      variant: {
        default:
          "variant-default | relative bg-primary text-primary-foreground shadow-[inset_0_1.5px_0_0_hsl(var(--border)/0.5),inset_0_-2px_4px_2px_rgba(0,0,0,0.4)] hover:brightness-110 disabled:active:scale-100 duration-150",
        destructive:
